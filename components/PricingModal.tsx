...
//     reason?: "credits" | "upgrade";
// }
// const PricingModel = ({ children, reason = "upgrade" }:
//     PricingModelProps) => {
//     const title =
//         reason === "credits" ? "You are out of credits" : "Upgrade your plan";
//     const description = reason === "credits" ? "You have used all your credits. upgrade to keep building."
//         : "Choose a plan that fit how much you build.";
//     return (
//         <Dialog>
//             <DialogTrigger className={"cursor-pointer"}>{children}</DialogTrigger>
//             <DialogContent className={"border-white/8 bg-[#0f0f0f] p-0 text-white sm:max-w-6xl max-h-[90dvh] overflow-y-auto"}>
//                 <DialogHeader className="px-6 pt-6 pb-2">
//                     <DialogTitle className="font-serif text-x1 tracking-tight text-white/90">
//                         <BlueTitle className="text-4xl">{title}</BlueTitle>
//                     </DialogTitle>
//                     <DialogDescription className="text-sm text-white/35">
//                         {description}
